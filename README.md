...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create blogmix-b58b
  fly apps create blogmix-b58b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app blogmix-b58b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app blogmix-b58b-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'blogmix-b58b-staging' does not match app name in config file 'blogmix-b58b'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name blogmix-b58b-db
  fly postgres attach --app blogmix-b58b blogmix-b58b-db

  fly postgres create --name blogmix-b58b-staging-db
  fly postgres attach --app blogmix-b58b-staging blogmix-b58b-staging-db
  ```
